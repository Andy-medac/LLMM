...
<body>
    <div class="container">
        ...
        <table>
            ...
            { 
                for $cliente in doc("clientes.xml")/clientes/cliente
                return
                    <tr>
        ...
        <table>
            ...
            { 
                let $maxGasto := max(doc("clientes.xml")/clientes/cliente/total_gastado)
                for $cliente in doc("clientes.xml")/clientes/cliente
        ...
        <br/>
        <h3>El total gastado es {sum(doc("clientes.xml")/clientes/cliente/total_gastado)} € por los clientes</h3>
        <br/>
    </div>
</body>
</html>